...
`com/Learn/module/nameattributes/lname.py` 的代码：
...
`com/Learn/module/nameattributes/user_lname.py` 的代码：
...
import lname   # 导入 lname 模块
```

运行 `user_lname.py` ，输出结果：
...
└── com
    └── Learn
        └── module
            └── nameattributes
                ├── __init__.py
                ├── lname.py        ← com.Learn.module.nameattributes.lname
                └── user_lname.py
            └── __init__.py
        └── __init__.py
    └── __init__.py
